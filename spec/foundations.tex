...
$\phi$ is \textbf{assignment-satisfable with respect to} $S$ iff
for any  $\L$-structure $\M$ with domain $A$ and any assignment $j:\V\to \A$, there exists $\M'\in\MM_S(\M)$ such that $\M', j\models \phi$. 
\end{definition}

\begin{lemma}
\label{assignment-satisfable-modus-ponens}
Let $\L=(\mathscr{P}, \mathscr{F}, \arity)$ be a signature of a language and let $S\subset \PP\cup\FF$. Let $\phi, \psi\in \B(\L)$ be such that $\phi$ is assignment-satisfable with respect to $S$ and no symbol from $S$ occurs in $\psi$.
...
Since $\phi$ is assignment-satisfable with respect to $S$, for the given structure $\M$ with domain $A$ and assignment $j:\V\to A$, there exists $\M''\in\MM_S(\M)$ such that $\M'', j\models \phi$.
...
\begin{lemma}
\label{assignment-satisfable-modus-ponens-rule}
Let $\L=(\mathscr{P}, \mathscr{F}, \arity)$ be a signature of a language and let $S\subset \PP\cup\FF$. Let $\phi, \psi\in \B(\L)$ be such that $\phi$ is assignment-satisfable and no symbol from $S$ occurs in $\psi$. Let $\M$ be an $\L$-structure.
Then
\begin{equation}
...
By Lemma \ref{assignment-satisfable-modus-ponens}, since $\phi$ is assignment-satisfable, no symbol from $S$ occurs in $\psi$, and $\M',j\models \phi\to\psi$ for any $\M'\in\MM_S(\M)$, we have $\M,j\models \psi$.
...
\begin{lemma}
\label{biconditional-assignment-satisfable}
...
Then $q(\bm{x}) \liff \phi$ is assignment-satisfable with respect to $\{q\}$.
\end{lemma}
...
Therefore, $q(\bm{x}) \liff \phi$ is assignment-satisfable with respect to $\{q\}$.
\end{proof}
...
\begin{proof}
By Lemma \ref{biconditional-assignment-satisfable}, $q(\bm{x}) \liff \phi$ is assignment-satisfable.

Since $q$ does not occur in $\psi$, by Lemma \ref{assignment-satisfable-modus-ponens-rule} with $S = \{q\}$ and $\phi$ replaced by $q(\bm{x}) \liff \phi$, we have: if $\M'\models (q(\bm{x}) \liff \phi) \to \psi$ for any $\M'\in\MM_q(\M)$, then $\M\models \psi$.
\end{proof}
...
Then $(\exists x.\phi) \to \phi(x/f(\bm{u}))$ is assignment-satisfable with respect to $\{f\}$.
\end{lemma}
...
Thus $(\exists x.\phi) \to \phi(x/f(\bm{u}))$ is assignment-satisfable with respect to $\{f\}$.
\end{proof}
...
\begin{proof}
By Lemma \ref{skolemisation-schema-lemma}, $(\exists x.\phi) \to \phi(x/f(\bm{u}))$ is assignment-satisfable with respect to $\{f\}$.

Since $f$ does not occur in $\psi$, by Lemma \ref{assignment-satisfable-modus-ponens-rule} with $S = \{f\}$ and $\phi$ replaced by $(\exists x.\phi) \to \phi(x/f(\bm{u}))$, we have: if $\M'\models ((\exists x.\phi) \to \phi(x/f(\bm{u}))) \to \psi$ for any $\M'\in\MM_f(\M)$, then $\M\models \psi$.
\end{proof}
