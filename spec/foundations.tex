...
\begin{enumerate}
\item If $\tau \sxeq v$ then $v$ is a \textbf{variable in} term $\tau$.
\item If $\tau \sxeq f(\tau_1, \dots \tau_k)$ where $f\in \mathscr{F}_k$ and $\tau_1, \dots \tau_k$ are terms and $v$ is a \textbf{variable in} some term $\tau_i$ where $i$ is an integer with $1 \leq i \leq k$, then $v$ is a \textbf{variable in} term $\tau$.
...
\begin{enumerate}
\item If $\phi \sxeq p(\tau_1, \dots, \tau_k)$ where $p\in \mathscr{P}_k$ and $\tau_1, \dots, \tau_k$ are terms, and $v$ is a \textbf{variable in} some term $\tau_i$ where $i$ is an integer with $1 \leq i \leq k$, then $v$ is a \textbf{variable in} $\phi$.
\item If $\phi \sxeq \alpha \to \beta$ where $\alpha, \beta\in\B(\L)$, and $v$ is a \textbf{variable in} $\alpha$ or $v$ is a \textbf{variable in} $\beta$, then $v$ is a \textbf{variable in} $\phi$.
\item If $\phi \sxeq \forall x. \psi$ where $x\in \V$ and $\psi\in\B(\L)$, and either $v = x$ or $v$ is a \textbf{variable in} $\psi$, then $v$ is a \textbf{variable in} $\phi$.
...
\item If $\phi \sxeq \alpha \to \beta$ where $\alpha, \beta\in\B(\L)$, and $v$ is a \textbf{free variable in} $\alpha$ or $v$ is a \textbf{free variable in} $\beta$, then $v$ is a \textbf{free variable in} $\phi$.
\item If $\phi \sxeq \forall x. \psi$ where $x\in \V$ and $\psi\in\B(\L)$ and $v$ is not $x$ and $v$ is a \textbf{free variable in} $\psi$, then $v$ is a \textbf{free variable in} $\phi$.
...
\item If $\phi \sxeq \forall y. \psi$ where $y\in \V$ and $\psi\in\B(\L)$ and $y \sxeq x$, then $\phi(x/\tau) \defeq \forall y. \psi$.
\item If $\phi \sxeq \forall y. \psi$ where $y\in \V$ and $\psi\in\B(\L)$ and $y$ is not $x$ and $y$ is not a variable in $\tau$, then $\phi(x/\tau) \defeq \forall y. \psi(x/\tau)$.
...
Let $x\in \V$ and $\tau$ be a term. Let $y\in \V$ and $y$ is not in term $\tau$ and $y$ is not in term $\sigma$.
Then
\begin{equation}
...
Since $y$ is not a \textbf{variable in} $\sigma$, we have $v\neq y$. Then $\sigma(x/y) \sxeq v$, and
\begin{equation*}
...
Since $y$ is not a \textbf{variable in} $\sigma$, $y$ is not a \textbf{variable in} any $\sigma_i$ for $i = 1, \dots, k$. By the definition of substitution in term, $\sigma(x/y) \sxeq f(\sigma_1(x/y), \dots, \sigma_k(x/y))$. Then
\begin{equation*}
...
\textbf{Subcase 4a:} If $y = x$, then by the definition of substitution, $\phi(x/\tau) \sxeq \forall y. \psi$. Thus
\begin{align*}
(\M, j\cfrac{\tau^{(\M, j)}}{x})\models \phi &\iff \phi^{\M, j\cfrac{\tau^{(\M, j)}}{x}} = 1 \\
...
\textbf{Subcase 4b:} If $y\neq x$ and $y$ is not a \textbf{variable in} $\tau$, then by the definition of substitution, $\phi(x/\tau) \sxeq \forall y. \psi(x/\tau)$. By inductive hypothesis, for any $a\in A$,
